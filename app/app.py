...
from app.back.database import ESTADOS_VALIDOS, Database
from app.front.components import get_pie_chart, mobile_view, navbar, pc_view
                ...
                rx.vstack(
                    ...
                    rx.flex(
                        rx.input(
                            ...
                            on_change=Database.set_search_text,
                            flex="1",
                            radius="full",
                        ),
                        rx.select(
