        ...
        rx.cond(
            ...
            rx.box(
                ...
                rx.vstack(
                    ...
                    rx.flex(
                        rx.input(placeholder="Buscar por ID o notas...", on_change=Database.set_search_text, flex="1", radius="full"),
                        # FILTRO POR ESTADO
                        rx.select(
                            ["TODOS", "ABIERTO", "EN RESOLUCION", "RESUELTO"], 
                            on_change=Database.set_status_filter, 
                            width="160px", 
                            radius="full"
                        ),
                        width="100%", spacing="2"
                    ...
                    rx.box(
                        rx.table.root(
                            rx.table.header(rx.table.row(rx.table.column_header_cell("ID"), rx.table.column_header_cell("FECHA"), rx.table.column_header_cell("ESTADO"), rx.table.column_header_cell("ALERTA"), rx.table.column_header_cell("NOTAS"))),
                    ...
                    rx.box(
                        ...
                        display=["block", "block", "none"], width="100%", bg=CARD_BG, border_radius="15px", overflow="hidden", border=CARD_BORDER
                    ),
...
app = rx.App(theme=rx.theme(accent_color="blue", radius="large", appearance="light"))
