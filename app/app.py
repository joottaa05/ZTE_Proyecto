    ...
    return rx.box(
        ...
        rx.vstack(
            ...
            rx.vstack(
                ...
                border_radius="25px", width="100%", 
                border="1px solid #E5E7EB", box_shadow="0px 10px 30px rgba(0,0,0,0.08)", 
                align_items="center",
                # Margen superior extra en móvil para compensar la falta de título
            ...
            rx.grid(
                rx.foreach(Database.group_names, lambda name: rx.vstack(
                    ...
                    padding="2em", bg=rx.color_mode_cond("white", "#1E1E20"), 
                    border_radius="25px", width="100%", 
                    border="1px solid #E5E7EB", box_shadow="0px 10px 30px rgba(0,0,0,0.05)", 
                    align_items="center"
                )),
                columns=rx.breakpoints(initial="1", sm="2"), 
                spacing="7", width="100%", margin_top="2em"
            ),
...
def details() -> rx.Component:
    return rx.box(
        navbar(),
        rx.vstack(
            # Título de Recurso: Solo visible en PC
            rx.heading(
            ...
            # Buscador y Filtro: Ajustamos margen en móvil
            rx.flex(
                ...
                rx.table.root(
                    rx.table.header(
                        rx.table.row(
                            ...
                            bg=rx.color_mode_cond("#F9FAFB", "#111113")
                        )
                    ),
            ...
            # VISTA DE LISTA/CARDS (Solo Móvil)
            rx.box(
                rx.vstack(
                ...
                display=["block", "block", "none"], # VISIBLE EN MÓVIL
                width="100%", 
